...
public class MyWebBrowser extends PBase {

	private  final Logger log = LogManager.getLogger(MyWebBrowser.class.getName());

	 Alert alert;

	public  void close(WebDriver ldriver) throws MyOwnException {
	...
	public  void quit(WebDriver ldriver) throws MyOwnException {
	...
	public  WebElement locateElementBy(WebDriver ldriver, String locatorName, String locatorValue)
	...
	public  List<WebElement> locateElementsBy(WebDriver ldriver, String locatorName, String locatorValue)
			throws MyOwnException {
	...
	public  void openUrl(WebDriver ldriver, String url) throws MyOwnException {
	...
	public  String getPageTitle(WebDriver ldriver) throws MyOwnException {
	...
	public  void maximize(WebDriver ldriver) throws MyOwnException {
	...
	public  String getCurrentURL(WebDriver ldriver) throws MyOwnException {
	...
	public  void navigateToUrl(WebDriver ldriver, String url) throws MyOwnException {
	...
	public  void navigateForward(WebDriver ldriver) throws MyOwnException {
	...
	public  void navigateBackward(WebDriver ldriver) throws MyOwnException {
	...
	public  void refresh(WebDriver ldriver) throws MyOwnException {
	...
	public  String getCurrentWindowHandle(WebDriver ldriver) throws MyOwnException {
	...
	public  void switchToWindow(WebDriver ldriver, String handle) throws MyOwnException {
		...
		try {
			if (ldriver != null) {
				if (frameElement != null) {
					if (mywebEle.isDisplayedOrNot(frameElement) == true) {
