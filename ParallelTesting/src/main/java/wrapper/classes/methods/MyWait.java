...
public class MyWait extends PBase {

	private  final Logger log = LogManager.getLogger(MyWait.class.getName());

	 WebDriverWait wait;

	public  void implicitlyFor(WebDriver ldriver, int duration, String durationType) throws MyOwnException {
	...
	public  void tillPageLoads(WebDriver ldriver, int duration, String durationType) throws MyOwnException {
	...
	public  void byDefaultFor(long duration) throws MyOwnException {
	...
	public  void until(WebDriver ldriver, String expectedCondition, int duration, WebElement element)
	...
	public  void until(WebDriver ldriver, String expectedCondition, int duration, String text)
			throws MyOwnException {
	...
	public  void untilAlertIsPresent(WebDriver ldriver, int duration) throws MyOwnException {
