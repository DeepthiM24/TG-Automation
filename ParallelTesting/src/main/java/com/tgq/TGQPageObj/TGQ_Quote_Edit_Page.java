...
public class TGQ_Quote_Edit_Page extends PTGQAllPages {
	...
	public void quotEdit() throws MyOwnException, InterruptedException {
		...
		try {
			...
			/*
			 * base.screenShot("./Results/Screenshots_" + testCaseNumber+ testRunTimeStamp +
			 * "/" + "Error in Opening QuoteEdit Tab.png");
			 * reportVar.logTestCaseStatusWithSnapShot(parentTestCase, "FAIL",
			 * "<font color=red><b>Error while Opening QuoteEdit: </b></font><br />" +
			 * exp.getMessage() + "<br />", "./Results/Screenshots_" +testCaseNumber+
			 * testRunTimeStamp + "/" + "Error in Opening QuoteEdit Tab.png");
			 */
