...
public class TGQ_Final_Policy_Page extends PTGQAllPages {
	...
	public void policyPage() throws MyOwnException, InterruptedException {
		...
		try {
			 ...
			 * "PASS","Final Policy Tab","./Results/Screenshots_" + testCaseNumber+
			 * testRunTimeStamp + "/" + "Policy Tab.png");
			 */
		} catch (Exception exp) {
			 ...
			 * "<font color=red><b>Error while Opening Policy Tab: </b></font><br />" +
			 * exp.getMessage() + "<br />", "./Results/Screenshots_"+testCaseNumber+
			 * testRunTimeStamp + "/" + "Error in Opening Policy Tab.png");
			 */
