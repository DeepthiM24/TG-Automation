...
public class TGQ_Payment_Page extends PTGQAllPages {
	...
	public void paymenttab() throws MyOwnException, InterruptedException {
		...
		try {
			if (mywebEle.isCloseButtonExist("//*[@src='images/popup_close.gif']")) {
				ldriver.findElement(By.xpath("//*[@src='images/popup_close.gif']")).click();
			}
			mywebEle.enterText(ins_debit_credit, downpayment_value.getText());
			mywebEle.enterText(card_number, "4012000033330026");
			mywebEle.enterText(name_on_card, "Abcd Efgh");
			...
			/*
			 * base.screenShot("./Results/Screenshots_" +testCaseNumber+ testRunTimeStamp +
			 * "/" + "Error in Opening PaymentTab.png");
			 * reportVar.logTestCaseStatusWithSnapShot(parentTestCase, "FAIL",
			 * "<font color=red><b>Error while Opening PaymentTab: </b></font><br />" +
			 * exp.getMessage() + "<br />", "./Results/Screenshots_" + testCaseNumber+
			 * testRunTimeStamp + "/" + "Error in Opening PaymentTab.png");
			 */
