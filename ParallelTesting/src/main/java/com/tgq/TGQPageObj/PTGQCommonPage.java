...
public class PTGQCommonPage extends PTGQAllPages {

	private static final Logger log = LogManager.getLogger(PTGQCommonPage.class.getName());

	WebDriver ldriver;
	

	public PTGQCommonPage(WebDriver driver) {
		super(driver);
		this.ldriver = driver;
	...
	public void initiateTGQBrowser() throws Exception {
		...
		//	tgQTrackerspages = new PTGQAllPages(ldriver);
			System.out.println(driver+"TGQ Comom dgfu");
