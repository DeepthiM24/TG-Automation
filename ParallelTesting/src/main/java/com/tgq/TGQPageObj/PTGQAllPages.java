...
public class PTGQAllPages extends PBase {

	WebDriver ldriver;

	public PTGQAllPages(WebDriver dr) {
	...
	public PMarsApplicationLoginPage loginPage() throws MyOwnException {
		...
		return new PMarsApplicationLoginPage(ldriver);
	}
