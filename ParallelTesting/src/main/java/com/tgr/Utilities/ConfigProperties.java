...
public class ConfigProperties extends PBase {
	private static final Logger log = LogManager.getLogger(ConfigProperties.class.getName());

	public  Properties loadFrom(String propertyFilePath, String propertyFileName) throws MyOwnException {
	...
	private  Properties createPropertiesInstance() throws MyOwnException {
	...
	private  void loadProperties(FileInputStream fs) throws MyOwnException {
